...
<head>
    ...
    <title>Thuthuka Khoza - Software Developer</title>
...
<body>
    ...
    <nav class="navbar navbar-expand-lg fixed-top">
        <div class="container">
            <a class="navbar-brand" href="#home">Thuthuka Khoza</a>
            ...
            <div class="collapse navbar-collapse" id="navbarNav">
                ...
                <a href="mailto:thuthukakhoza@gmail.com" class="btn btn-primary ms-3">
                ...
                <div class="col-lg-12 text-center">
                    <div class="hero-content text-center">
                        ...
                        <div class="d-flex gap-3 flex-wrap justify-content-center">
                            ...
                            <a href="https://www.linkedin.com/in/thuthuka-khoza-976729177/" class="btn btn-outline-light rounded">
                        ...
                        <div class="tech-stack d-flex flex-wrap justify-content-center">
        ...
        <div class="container">
            ...
            <div class="row g-4">
                <div class="col-lg-4 col-md-6">
                    <div class="project-card">
                        <div class="project-image">
                            <img src="images\portfolio\Screenshot 2025-07-11 at 23.27.46.png" alt="Kofi queue">
                        </div>
                        <div class="project-content">
                            <h3 class="project-title">Kofi Barber Shop</h3>
                            <p class="project-description">
                               Web application with real-time queue management, user authentication, and an admin dashboard 
                               for monitoring and management of queues, bookings and services.
                            </p>
                            ...
                            <div class="project-links">
                                <a href="https://kofi.bakili.co.za/" class="project-link">
                                    <i class="fas fa-external-link-alt me-1"></i>Live Demo
                                </a>
                                <a href="https://github.com/Thuthukak/koffi" class="project-link">
                ...
                <div class="col-lg-4 col-md-6">
                    <div class="project-card">
                        <div class="project-image">
                            <img src="images\portfolio\shape-africa.png" alt="Shape Africa">
                        </div>
                        <div class="project-content">
                            <h3 class="project-title">CRM Web App</h3>
                            <p class="project-description">
                                CRM web app with Role based user authentication, Lead management, Deal management, 
                                Project management, Objectives and KPIs, and task scheduling features.
                            </p>
                            <div class="project-tech">
                                <span class="tech-tag">Laravel</span>
                                <span class="tech-tag">PHP</span>
                            ...
                            <div class="project-links">
                                <a href="https://shape.africa/Home" class="project-link">
                                    <i class="fas fa-external-link-alt me-1"></i>Live Demo
                                </a>
                                <a href="https://github.com/Thuthukak/community_work_programme" class="project-link">
                                    <i class="fab fa-github me-1"></i>Source Code
                                </a>
                            </div>
                        </div>
                ...
                <div class="col-lg-4 col-md-6">
                    <div class="project-card">
                        <div class="project-image">
                           <img src="images\portfolio\voting_app.png" alt="Project 1">
                        </div>
                        <div class="project-content">
                            <h3 class="project-title">Siyavota Android App</h3>
                            <p class="project-description">
                                Developed a secure Android voting app using Java, Kotlin, and Firebase for the University 
                                of Mpumalanga SRC elections. Enabled remote student registration and voting, replacing in-person 
                                ballots during COVID-19.
                            </p>
                            <div class="project-tech">
                            ...
                            <div class="project-links">
                                ...
                                <a href="https://github.com/Thuthukak/ump_vote" class="project-link">
                                    <i class="fab fa-github me-1"></i>Source Code
                                </a>
                            </div>
                        </div>
            ...
            <div class="row g-4">
                ...
                <div class="col-lg-4 col-md-6">
                    <div class="skill-category">
                        ...
                        <h3 class="skill-title">Database & DevOps</h3>
                        <ul class="skill-list">
